...
setup('authenticate', async ({ browser }) => {
  ...
  // Call the developer message API and log the response
  try {
    const response = await fetch('https://developer-message.mightora.io/api/HttpTrigger?appname=playwrightForPowerPlatformAuthTest');
